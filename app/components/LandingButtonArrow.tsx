...
export default function LandingButtonArrow({ href, text }: Props) {
  return (
      <Link href={href} className="group p-0 xl:py-8 xl:pl-8 xl:pr-0 lg:w-auto text-accent transition-all opacity-80 transition-opacity hover:opacity-95 duration-300 flex items-center justify-center lg:justify-start space-x-6  pointer-events-auto cursor-pointer">
