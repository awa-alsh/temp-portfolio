      ...
      <div className="relative w-full h-auto md:w-[45%] p-6 z-10 mt-[250px] md:mt-0">
        <div className="flex flex-col gap-4 justify-between h-full">
          ...
          <div className="flex items-center space-x-2 mt-4 lg:mt-8 xl:mt-12">
            <span className={`font-medium text-l lg:text-xl ${isUnavailable ? 'text-text-secondary' : 'text-accent'}`}>
            ...
            {isUnavailable ? (
              ...
              <svg width="24" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg" className="arrow-icon w-[40px] lg:w-[50px] h-auto">
